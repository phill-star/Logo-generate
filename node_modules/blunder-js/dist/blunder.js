...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		root["blunder"] = root["blunder"] || {}, root["blunder"]["Client"] = factory();
...
var promise_1 = __webpack_require__(/*! ./promise */ "./src/promise.js");
var stacktracejs_1 = __webpack_require__(/*! ./processor/stacktracejs */ "./src/processor/stacktracejs.js");
var ignore_1 = __webpack_require__(/*! ./filter/ignore */ "./src/filter/ignore.js");
var debounce_1 = __webpack_require__(/*! ./filter/debounce */ "./src/filter/debounce.js");
var uncaught_message_1 = __webpack_require__(/*! ./filter/uncaught-message */ "./src/filter/uncaught-message.js");
var angular_message_1 = __webpack_require__(/*! ./filter/angular-message */ "./src/filter/angular-message.js");
var window_1 = __webpack_require__(/*! ./filter/window */ "./src/filter/window.js");
var node_1 = __webpack_require__(/*! ./filter/node */ "./src/filter/node.js");
var reporter_1 = __webpack_require__(/*! ./reporter/reporter */ "./src/reporter/reporter.js");
var fetch_1 = __webpack_require__(/*! ./reporter/fetch */ "./src/reporter/fetch.js");
var node_2 = __webpack_require__(/*! ./reporter/node */ "./src/reporter/node.js");
var xhr_1 = __webpack_require__(/*! ./reporter/xhr */ "./src/reporter/xhr.js");
var historian_1 = __webpack_require__(/*! ./instrumentation/historian */ "./src/instrumentation/historian.js");
var Client = /** @class */ (function () {
    function Client(opts) {
        ...
        if (opts.user)
            this.opts.user = opts.user;
        if (opts.environment)
            this.opts.environment = opts.environment;
        if (opts.component)
            this.opts.component = opts.component;
        if (opts.host)
    ...
    Client.prototype.setComponent = function (component) {
        this.opts.component = component;
    };
    Client.prototype.setEnvironment = function (env) {
        this.opts.environment = env;
    };
    Client.prototype.getUser = function () {
        return this.opts.user;
    };
    Client.prototype.setUser = function (userId, userEmail, userName) {
    ...
    Client.prototype.setUserEmail = function (userEmail) {
        this.opts.user = this.opts.user || {};
        this.opts.user.email = userEmail;
    };
    ...
    Client.prototype.notify = function (err) {
        ...
        if (!err.error) {
            var reason = new Error("blunder-js: got err=" + JSON.stringify(err.error) + ", wanted an Error");
            promise.reject(reason);
            return promise;
        }
        if (this.opts.ignoreWindowError && err.context && err.context.windowError) {
            var reason = new Error('blunder-js: window error is ignored');
            promise.reject(reason);
            return promise;
        }
        if (this.offline) {
...
/***/ "./src/filter/uncaught-message.js":
/*!****************************************!*\
  !*** ./src/filter/uncaught-message.js ***!
  \****************************************/
/*! no static exports found */
...
/***/ "./src/instrumentation/historian.js":
/*!******************************************!*\
  !*** ./src/instrumentation/historian.js ***!
  \******************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var dom_1 = __webpack_require__(/*! ./dom */ "./src/instrumentation/dom.js");
...
function jsonifyNotice(notice, maxLength) {
    ...
    var err = new Error("blunder-js: cannot jsonify notice (length=" + s.length + " maxLength=" + maxLength + ")");
    err.params = {
...
Object.defineProperty(exports, "__esModule", { value: true });
var jsonify_notice_1 = __webpack_require__(/*! ../jsonify-notice */ "./src/jsonify-notice.js");
var reporter_1 = __webpack_require__(/*! ./reporter */ "./src/reporter/reporter.js");
...
function report(notice, opts, promise) {
    ...
    var url = opts.host + "/api/v1/projects/" + opts.projectId + "/problems?key=" + opts.projectKey;
    ...
    fetch(url, opt).then(function (req) {
        ...
        req.text().then(function (body) {
            var err = new Error("blunder: fetch: unexpected response: code=" + req.status + " body='" + body + "'");
            promise.reject(err);
        });
    }).catch(function (err) {
        promise.reject(err);
...
function report(notice, opts, promise) {
    ...
    request({
        ...
        body = body.trim();
        var err = new Error("blunder: node: unexpected response: code=" + response.statusCode + " body='" + body + "'");
        promise.reject(err);
    });
}
exports.default = report;
...
function report(notice, opts, promise) {
    ...
    req.onreadystatechange = function () {
        ...
        var err = new Error("blunder: xhr: unexpected response: code=" + req.status + " body='" + body + "'");
        promise.reject(err);
    };
    req.send(payload);
}
...
//# sourceMappingURL=blunder.js.map